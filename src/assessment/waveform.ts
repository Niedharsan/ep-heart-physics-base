...
function sinusIntervals(parameters: SinusScenarioParameters): readonly IntervalDefinition[] {
  return Object.freeze([
    Object.freeze({
      id: 'AH',
      title: 'AH interval',
      startLandmark: 'atrial-his',
      endLandmark: 'his-onset',
      ...
      explanatoryPrompt: 'Measure from the intrinsic atrial deflection on the His channel to the earliest onset of the His electrogram.',
    }),
    Object.freeze({
      id: 'HV',
      title: 'HV interval',
      startLandmark: 'his-onset',
      endLandmark: 'ventricular-onset',
      expectedValueMs: parameters.hvMs,
      measurementToleranceMs: parameters.measurementToleranceMs,
      landmarkToleranceMs: 12,
      normalRange: hvNormalRange,
      explanatoryPrompt: 'Measure from the earliest onset of the His electrogram to the earliest recorded ventricular activation.',
    }),
    Object.freeze({
      id: 'PR',
      title: 'PR interval',
      startLandmark: 'p-onset',
      endLandmark: 'ventricular-onset',
      expectedValueMs: parameters.prMs,
      measurementToleranceMs: parameters.measurementToleranceMs,
      landmarkToleranceMs: 12,
      explanatoryPrompt: 'Measure from surface P-wave onset to the earliest ventricular activation.',
    }),
    Object.freeze({
      id: 'RR',
      title: 'RR / cycle length',
      startLandmark: 'ventricular-onset',
      endLandmark: 'ventricular-onset',
      expectedValueMs: parameters.cycleLengthMs,
      measurementToleranceMs: parameters.measurementToleranceMs,
      landmarkToleranceMs: 12,
      explanatoryPrompt: 'Measure between equivalent ventricular onsets in consecutive cycles.',
    }),
  ]);
}
...
export function createRetrogradeEgmScenario(parameters: RetrogradeScenarioParameters): EgmScenario {
  ...
  const intervals: readonly IntervalDefinition[] = Object.freeze([
    Object.freeze({
      ...
      title: 'VA interval',
      startLandmark: 'ventricular-onset',
      endLandmark: 'retrograde-atrial-onset',
      expectedValueMs: parameters.vaMs,
      measurementToleranceMs: parameters.measurementToleranceMs,
      landmarkToleranceMs: 12,
      explanatoryPrompt: 'Measure from the earliest ventricular onset to the earliest retrograde atrial onset.',
    }),
    Object.freeze({
      id: 'RR',
      ...
      measurementToleranceMs: parameters.measurementToleranceMs,
      landmarkToleranceMs: 12,
      explanatoryPrompt: 'Measure between equivalent ventricular onsets in consecutive paced cycles.',
    }),
  ]);
